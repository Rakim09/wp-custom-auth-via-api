...
final class Requirements extends Base {
	...
	public function specifications(): array {
		return apply_filters( 'custom_auth_via_api_plugin_requirements', [
		...
		foreach (
			[
				...
				[
					...
					'title'   => __( 'Invalid PHP version', 'custom-auth-via-api' ),
					'message' => sprintf( /* translators: %1$1s: required php version, %2$2s: current php version */
						__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'custom-auth-via-api' ),
				...
				[
					...
					'title'   => __( 'Invalid WordPress version', 'custom-auth-via-api' ),
					'message' => sprintf( /* translators: %1$1s: required wordpress version, %2$2s: current wordpress version */
						__( 'You must be using WordPress %1$1s or greater. You are currently using WordPress %2$2s.', 'custom-auth-via-api' ),
