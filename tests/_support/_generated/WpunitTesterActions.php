<?php  //[STAMP] fe9037ebda7cf903e5ade066a8efa7b9
...
trait WpunitTesterActions
{
     ...
     *
     *
     * @see \Helper\WPUnit::has_filter()
     */
    public function has_filter($filter, $obj, $function): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('has_filter', func_get_args()));
    }
}
